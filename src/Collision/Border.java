...
public class Border {
    public javafx.scene.shape.Line[] createLines(){
        ...
        lines[2] = new Line(715,195,760,165);
        // i = 5; j = 2; Topansicht X-Z
        lines[3] = new Line(270,30,230,70);
        // i = 6; j = 3; Seitenansicht Y-Z
        lines[4] = new Line(130,327,170,367);
        // i = 7; j = 2; Topansicht X-Z
        lines[5] = new Line(270,215,230,270);
        // i = 9; j = 2; Topansicht X-Z
        lines[6] = new Line(70,230,30,270);
        // i = 10; j = 2; Topansicht X-Z
        lines[7] = new Line(30,330,70,370);
